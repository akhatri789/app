...
class BusinessSettingsController extends Controller
{
    ...
    public function medicine_surgery()
    {
        ...
        return view('admin-views.business-settings.medicine-surgery', compact('medicine_surgery'));
    }
      public function medicalupdate(Request $data)
    {
        $validatedData = $data->validate([
            'value' => 'required',
        ]);
        BusinessSetting::where('type', 'medicine_surgery')->update(['value' => $data->value]);
    ...
    public function companyInfo()
    {
        ...
        $convenience_fee = BusinessSetting::where('type', 'convenience_fee')->first();
    ...
    public function updateInfo(Request $request)
    {
        ...
        // web convinious fee setup
        $convenience_fee = BusinessSetting::where('type', 'convenience_fee')->first();
        if (isset($convenience_fee)) {
            BusinessSetting::where('type', 'convenience_fee')->update([
                'value' => json_encode(
                    [
                        'limit' => $request['convenience_fee_limit'],
                        'rate' => $request['convenience_fee_rate'],
                    ]),
            ]);
        } else {
            DB::table('business_settings')->insert([
