...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $p->after_discount_price = BackEndHelper::currency_to_usd($request->unit_price - $dis);
        ...
        $p->price_range = $request->price_range;
        if ($request->ajax()) {
    ...
    public function update(Request $request, $id)
    {
        ...
        $product->after_discount_price = BackEndHelper::currency_to_usd($request->unit_price - $dis);
